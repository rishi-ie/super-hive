...
export const workspaceTypeValues = ["worktree", "branch"] as const;
export const workspaceTypeEnum = z.enum(workspaceTypeValues);
export type WorkspaceType = z.infer<typeof workspaceTypeEnum>;

export const v2WorkspaceTypeValues = ["worktree", "branch"] as const;
...
export const automationPromptSourceValues = ["user", "restore"] as const;
